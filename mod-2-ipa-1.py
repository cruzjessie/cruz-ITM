...
def savings(gross_pay, tax_rate, expenses):
    ...
    after_tax = gross_pay - (float(tax_rate) * gross_pay)
    import math
    return int(math.floor(after_tax) - int(expenses))
    
    savings(100000,0.12,15000) 
...
def interest(principal, rate, periods):
    ...
    amount = (principal * (rate * periods)) + principal 
    import math
    return math.floor(amount)

    interest(10000,0.2,4)
